...
// Order statuses used for customer order filtering.
const orderStatuses = [
{
label: 'All Orders',
swahili: 'Oda Zote',
...
{
label: 'Completed',
swahili: 'Zimekamilika',
value: 'completed',
icon: CheckCircle2,
},
{
label: 'Cancelled',
swahili: 'Zimeghairiwa',
value: 'cancelled',
icon: XCircle,
},
]
...
)?.[isSwahili ? 'swahili' : 'label'] || 'All Orders'

const text = {
customer: isSwahili ? 'Mteja' : 'Customer',


myOrders: isSwahili ? 'Oda Zangu' : 'My Orders',

description: isSwahili
  ? 'Angalia na fuatilia oda unazoweka kupitia JamiiMarket.'
...
searchPlaceholder: isSwahili
  ? 'Tafuta kwa oda, bidhaa, au biashara...'
  : 'Search by order, product, or business...',
...
orderStatus: isSwahili
  ? 'Hali ya Oda'
  : 'Order status',

orders: isSwahili ? 'Oda' : 'Orders',

order: isSwahili ? 'oda' : 'order',

ordersPlural: isSwahili ? 'oda' : 'orders',

matching: isSwahili ? 'zinazolingana na' : 'matching',

noMatchingOrders: isSwahili
  ? 'Hakuna Oda Zinazolingana'
  : 'No matching orders',
...
noMatchingDescription: isSwahili
  ? 'Hakuna oda zinazolingana na utafutaji au hali uliyochagua. Badilisha vichujio au vifute ili kuona oda zote.'
  : 'No orders match your current search or status filter. Try changing the filters or clear them to see all available orders.',

noOrdersDescription: isSwahili
  ? 'Ukiweka oda kupitia JamiiMarket, taarifa ya oda yako itaonekana hapa.'
...
orderLabel: isSwahili ? 'Oda' : 'Order',
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="font-bold text-[#1B1C1C]">
                    {order.productName || text.orderLabel}
                  </h3>
