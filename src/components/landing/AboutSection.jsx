  ...
  const points = [
    {
      ...
      description: isSwahili
        ? 'JamiiMarket hutoa nafasi ya kidijitali ambapo biashara za ndani zinaweza kuwasilisha bidhaa na huduma zao kwa wateja.'
    ...
    },
    {
      ...
      description: isSwahili
        ? 'Wateja wanaweza kugundua biashara za ndani zinazoshiriki na bidhaa zinazopatikana kupitia jukwaa moja.'
    ...
    },
    {
      ...
      description: isSwahili
        ? 'Jukwaa limeundwa kusaidia wateja, biashara, na washiriki wa usafirishaji ndani ya soko.'
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start lg:gap-16">
          ...
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.14em] text-[#326460]">
              {isSwahili ? 'Tatizo Tunaloleta Suluhisho' : 'The Problem We Solve'}
            </p>
