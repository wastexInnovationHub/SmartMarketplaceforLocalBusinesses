      ...
      >
        ...
        <div className="flex min-h-20 shrink-0 items-center justify-between border-b border-white/10 px-4 sm:px-6">
          ...
          <button
            ...
            aria-label="Close business navigation menu"
            title="Close menu"
          >
            <X size={20} />
          </button>
        ...
        <div className="shrink-0 border-t border-white/10 p-3 sm:p-4">
          ...
          <NavLink
            ...
            onClick={onClose}
            className={({ isActive }) =>
              `mb-3 flex items-center gap-3 rounded-xl p-3 transition focus:outline-none focus:ring-2 focus:ring-[#326460] ${
                isActive
                  ? 'bg-[#326460]/30'
          ...
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#326460]/80">
              <Store size={17} />
            </div>
