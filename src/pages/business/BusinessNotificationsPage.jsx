      ...
      <div className="mx-auto max-w-5xl">
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-sm text-gray-500">
                Stay updated about your business activity
              </p>
            </div>
          </div>
        ...
        <section className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="flex flex-col gap-4 border-b border-gray-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Order, payment, delivery, and account updates will appear
                here.
              </p>
            </div>
          ...
          <div className="flex gap-2 overflow-x-auto border-b border-gray-100 p-4">
            {['All', 'Order', 'Payment', 'Delivery', 'Account'].map(
              (item) => (
                <button
                  key={item}
                  type="button"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                This notification center is ready to receive real
                marketplace events. Once the backend is connected,
                notifications can be generated from orders, payments,
