          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-[#695D46] sm:text-base">
                Find local shops, restaurants, service providers,
                artisans, professionals, and other businesses
        ...
        <section className="mb-7 overflow-hidden rounded-2xl border border-[#D9E8E5] bg-[#E9F3F1]">
          <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm leading-5 text-[#695D46]">
                  Location-based discovery will show real
                  businesses near you when location services and
                  marketplace data are available.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              title="Location discovery will be enabled when the marketplace location service is connected"
            >
              <MapPin size={17} />
                        ...
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-xs leading-5 text-[#695D46]">
                              This page does not create sample
                              businesses, addresses, phone numbers,
                              locations, or other fake marketplace
                              information.
                            </p>
                          </div>
